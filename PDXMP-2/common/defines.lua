...
country = {
	...
	PROVINCE_OVERSEAS_PENALTY = 0.06, -- Each province req. this many goods flagged as overseas penalty
	...
	UNCIV_TECH_SPREAD_MAX = 0.25, --Max techs an unciv will get on westernizing
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 28, -- base value that is powered by level of naval base. Determines the naval supplying capabilities.
	NAVAL_BASE_SUPPLY_SCORE_EMPTY = 2, -- min value for coastal provinces with no naval base.
	NAVAL_BASE_NON_CORE_SUPPLY_SCORE = 0.05, -- modifier for supply score for naval bases that are not in core provinces.
...
economy = {
	...
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 100000,
...
diplomacy = {
	...
	GOOD_PEACE_REFUSAL_MILITANCY = 0.0, --Militancy hit from refusing a good peace offer
	GOOD_PEACE_REFUSAL_WAREXH = 0.0, --War exhaustion hit from refusing a good peace offer
	...
	RANK_1_TENSION_DECAY = -0.0, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -0.0,
	RANK_3_TENSION_DECAY = -0.0,
	RANK_4_TENSION_DECAY = -0.0,
	RANK_5_TENSION_DECAY = -0.0,
	RANK_6_TENSION_DECAY = -0.0,
	RANK_7_TENSION_DECAY = -0.0,
	RANK_8_TENSION_DECAY = -0.0,
